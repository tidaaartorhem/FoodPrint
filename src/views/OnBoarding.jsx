...
const meta = {
  ...
  1: {
    ...
    subtitle: "Find the best alternatives according to your Macros.",
  },
  2: {
    title: "Reduce your CarbonFootprint",
    image: require("../../assets/images/fresh.png"),
    subtitle: "Help find alternative items in your cart that are both healthy and environmentally",
  },
};
...
export default function OnBoarding({ navigation }) {
  ...
  const viewBgRange = ["#32CD32", "#32CD32", "#32CD32", "#F2F2F2", "#F2F2F2"];
  const buttonBgRange = ["#F2F2F2", "#F2F2F2", "#F2F2F2", "#32CD32", "#32CD32"];
          ...
          <TouchableOpacity onPress={onPress}>
            ...
            >
              <FontAwesome5
                size={24}
                name="chevron-right"
                color={isButtonColorEven ? "#CCFFCC" : "#32CD32"}
              />
            </Animated.View>
          </TouchableOpacity>
        </Animated.View>
