...
export default function StoreToggle({ active, onToggle }) {
  ...
  const bgColorFruit = active === "FRUIT" ? "#32CD32" : "transparent";
  const bgColorVeggie = active === "VEGGIE" ? "#32CD32" : "transparent";

  const borderFruit = active === "VEGGIE" ? "#cccccc" : "#32CD32";
  const borderVeggie = active === "FRUIT" ? "#cccccc" : "#32CD32";
